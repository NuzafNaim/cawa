const SubscribeSection = () => {
  return <div>
    <div className="container mx-auto mt-16 mb-32 text-base flex justify-center items-center flex-col">
      <p className="uppercase text-brand font-medium mb-4 text-center">Subscribe</p>
      ...
      <div class="flex items-center border border-black rounded-xl p-1">
        <input class="appearance-none bg-transparent border-none w-96 text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Enter Your Email Adress" aria-label="Email"/>
